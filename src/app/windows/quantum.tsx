  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-3 text-sm">
        <p className="font-bold">Fun experiment generating pseudo-random events using quantum logic models</p>
        
        <div className="bg-gray-100 p-3 border border-black">
          <p className="mb-2">⚛️ <span className="font-bold">Quantum Features:</span></p>
